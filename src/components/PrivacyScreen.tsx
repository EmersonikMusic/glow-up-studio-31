          ...
          <div className="px-6 md:px-8 py-7 flex flex-col gap-6 game-text-white">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed font-body font-semibold">
                This is a placeholder privacy policy. Here we will explain how{" "}
                <span className="font-black">Triviolivia</span> collects, uses, and protects your
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed font-body font-semibold">
                We may collect basic account information, gameplay preferences, and device data to
                help improve your trivia experience. Any details you choose to share are used only to
                personalize and support the game.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed font-body font-semibold">
                Your information helps us keep score, remember your settings, and make Triviolivia
                better. We do not sell personal data to third parties.
              </p>
            </div>
