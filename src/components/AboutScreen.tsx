...
export default function AboutScreen({ onClose }: AboutScreenProps) {
  return (
    ...
    >
      ...
      {/* Card */}
      <div
        className="relative z-10 w-full max-w-lg mx-4 rounded-3xl overflow-hidden animate-fade-in"
        style={{
      ...
      >
        ...
        <button
          ...
          aria-label="Close"
        >
          <X className="w-5 h-5" style={{ color: "hsl(240 45% 16%)" }} />
        </button>
        ...
        <div className="px-8 py-7 flex flex-col gap-6">
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "hsl(var(--muted-foreground))", maxWidth: "55ch" }}
            >
              Here at{" "}
          ...
          <div>
            ...
            >
              ...
              to play a game with today's unlocked categories, or create an account to
              unlock them all for free!
            </p>
          </div>
        ...
        >
          <button
            onClick={onClose}
            className="w-full py-3.5 rounded-xl font-black text-sm tracking-widest uppercase transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] mt-4"
            style={{
