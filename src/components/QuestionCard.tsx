...
export default function QuestionCard({
  ...
  return (
    <div
      ...
      className="w-full rounded-2xl flex flex-col justify-start md:justify-center items-center animate-slide-in-up h-full backdrop-blur-xl pt-[calc(clamp(0.75rem,2.5vw,2.5rem)+40px)] pb-[calc(clamp(0.75rem,2.5vw,2.5rem)+165px)] md:pt-[clamp(0.75rem,2.5vw,2.5rem)] md:pb-[clamp(0.75rem,2.5vw,2.5rem)]"
      style={{
