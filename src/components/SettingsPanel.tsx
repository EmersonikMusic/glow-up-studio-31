      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              className="flex items-center gap-3 px-4 py-2.5 cursor-pointer shrink-0"
            ...
            {/* Individual categories — first 4 always visible, rest collapsible */}
